...
public class Game implements Parcelable {
     ...
     * We specify the data types, we gain efficiency from specifying the types ourselves.
     * Reflection, like in Serializable, is slow because it determines the types.
